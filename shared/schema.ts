...
export const invoices = pgTable("invoices", {
  ...
  // Post-extraction workflow fields
  classifiedItems: jsonb("classified_items"),
  projectMatch: jsonb("project_match"),
  pettyCashFlag: boolean("petty_cash_flag").default(false),
...
export const importedInvoices = pgTable("imported_invoices", {
  ...
  matchedFileId: integer("matched_file_id"), // Links XML to PDF
