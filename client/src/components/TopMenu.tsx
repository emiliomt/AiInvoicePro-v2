...
export default function TopMenu() {
  ...
  const getLinkClassName = (path: string) => {
    return isActiveRoute(path) 
      ? "text-primary-600 font-semibold text-sm border-b-2 border-primary-600 h-12 flex items-center whitespace-nowrap"
      : "text-gray-600 hover:text-gray-900 h-12 flex items-center transition-colors text-sm font-medium whitespace-nowrap";
  };
  ...
  return (
    <div id="top-menu-container" className="bg-white shadow-sm border-b border-gray-200 sticky top-0 z-50">
        ...
        <div className="flex justify-between items-center h-12">
          <div className="flex items-center space-x-4">
            <div className="flex items-center space-x-2">
              ...
              <h1 className="text-lg font-bold text-gray-900">AnzuDynamics</h1>
            </div>
          </div>
